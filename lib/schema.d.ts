...
export interface paths {
  ...
  "/api/kinobetjent/visning": {
    ...
    /**
     * Tilgjengjelige visninger
     * @description Betjenten får vist tilgjengelige visninger(som ikke har startet enda)
     */
    get: operations["hentTilgjengeligeVisninger_1"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
